      ...
      <div className="flex items-center justify-between flex-wrap gap-2">
        <div>
          <span className="text-sm font-medium text-white">
            💰 Pricing: 0.001 AVAX per call • ~$0.04 per call
          </span>
        </div>
        <div className="text-sm text-[#a1a1a1]">
          Your Balance: <span className="font-semibold text-white">{balance} AVAX</span> (enough for ~{callsRemaining.toLocaleString()} calls)
        </div>
      </div>
    </Card>
  );
