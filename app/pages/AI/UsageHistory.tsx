...
const UsageHistory: React.FC<UsageHistoryProps> = ({ history }) => {
  ...
  const exportToCSV = () => {
    ...
    // Define CSV headers
    const headers = ['Session', 'Date/Time (IST)', 'Type', 'Calls', 'Cost (USDC)', 'Transaction Hash'];
    ...
    link.setAttribute('download', `ai-usage-history-${timestamp}.csv`);
