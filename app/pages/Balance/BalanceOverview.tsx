    ...
    <div className="mb-8">
      <Card className="p-8 mb-6">
        <div className="text-center">
          ...
          <div className="text-5xl font-semibold text-white mb-2 font-mono">{balance} AVAX</div>
      ...
      {/* <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        <Card className="p-6" hoverEffect={true}>
          ...
          <div className="text-2xl font-semibold text-white font-mono mb-1">{breakdown.available} AVAX</div>
          <div className="text-xs text-[#a1a1a1]">Free to use</div>
        </Card>

        <Card className="p-6" hoverEffect={true}>
          <div className="text-sm text-[#a1a1a1] mb-2">Locked</div>
          <div className="text-2xl font-semibold text-white font-mono mb-1">{breakdown.locked} AVAX</div>
          <div className="text-xs text-[#a1a1a1]">In streams</div>
        </Card>

        <Card className="p-6" hoverEffect={true}>
          <div className="text-sm text-[#a1a1a1] mb-2">Total In</div>
          <div className="text-2xl font-semibold text-white font-mono mb-1">{breakdown.totalIn} AVAX</div>
          <div className="text-xs text-[#a1a1a1]">Deposited</div>
        </Card>

        <Card className="p-6" hoverEffect={true}>
          <div className="text-sm text-[#a1a1a1] mb-2">Total Out</div>
          <div className="text-2xl font-semibold text-white font-mono mb-1">{breakdown.totalOut} AVAX</div>
