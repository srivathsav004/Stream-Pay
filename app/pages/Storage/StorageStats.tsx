  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
      ...
      <Card className="p-6" hoverEffect={true}>
        ...
        <div className="text-3xl font-semibold text-white font-mono">{totalStored} GB</div>
      </Card>
      ...
      <Card className="p-6" hoverEffect={true}>
        ...
        <div className="text-3xl font-semibold text-white font-mono">{storageTime} hours</div>
      </Card>
    </div>
  );
};
