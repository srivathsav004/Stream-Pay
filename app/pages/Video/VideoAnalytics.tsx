      ...
      <Card className="p-6">
        ...
        {(!data || data.length === 0) ? (
          <div className="p-8 text-center border border-dashed border-[#262626] rounded-lg">
            ...
            <div className="text-white font-medium mb-1">No analytics yet</div>
            <div className="text-sm text-[#a1a1a1]">Start streaming or purchasing to see analytics here.</div>
          </div>
        ) : (
